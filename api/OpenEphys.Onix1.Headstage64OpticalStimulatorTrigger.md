...
> duration plus 1/frequency. Since the optical stimulator does not have a direct
> read-back path, you can infer your headstage version by observing the trigger
> behavior using the headstage's Intan chip's auxiliary input to which the
> electrical stimulus signal is hard-wired. The trigger behavior is the same for
> both stimulators. If you have an older headstage and require the specific
